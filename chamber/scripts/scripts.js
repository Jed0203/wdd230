...
const membersUrl = "https://jed0203.github.io/wdd230/chamber/data/member.json";
...
const url =
  "https://api.openweathermap.org/data/2.5/weather?lat=23.84&lon=120.98&appid=76cd0cc1ffbcb7fcbc8193cf2c4758e5";
...
async function getThreDayForecast() {
  const url =
    "https://api.openweathermap.org/data/2.5/forecast?lat=23.84&lon=120.98&appid=76cd0cc1ffbcb7fcbc8193cf2c4758e5&units=imperial";
  const response = await fetch(url);
